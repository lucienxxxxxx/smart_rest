            ...
            <div class="layui-form toolbar">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label w-auto">档口名称:</label>
                        <div class="layui-input-inline mr0">
                            <input name="keyword" class="layui-input" type="text" placeholder="请输入档口名称"/>
                        </div>
                    </div>
...
<script type="text/html" id="modelUser">
    <form id="modelUserForm" lay-filter="modelUserForm" class="layui-form model-form">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label layui-form-required">档口名称</label>
            <div class="layui-input-block">
                <input name="dangkouName" placeholder="请输入档口名称" type="text" class="layui-input" maxlength="20"
...
<script>
    layui.use(['layer', 'form', 'table', 'util', 'admin', 'formSelects', "xmSelect"], function () {
        ...
        var insTb = table.render({
            elem: '#tableUser',
            url: '${ctx}/dianpu/dangkou/list',/*改*/
            page: true,
            toolbar: true,
            cellMinWidth: 100,
            cols: [[
                {field: 'dangkouName', align: 'center', title: '逻辑号'},
        ...
        form.on('switch(tuopanTbStateCk)', function (obj) {
            ...
            $.post('${ctx}/dianpu/dangkou/switchStatus', {
                id: obj.elem.value,
        ...
        table.on('tool(tableUser)', function (obj) {
            ...
            if (layEvent === 'edit') { // 修改
                ...
                doDel(data.id, data.dangkouName);
            }
        });
        ...
        function showEditModel(mUser) {
            admin.open({
                ...
                success: function (layero, dIndex) {
                    ...
                    var url = mUser ? '${ctx}/dianpu/dangkou/addOrUpdate?flag=1' : '${ctx}/dianpu/dangkou/addOrUpdate?flag=0';
                    // 回显数据
