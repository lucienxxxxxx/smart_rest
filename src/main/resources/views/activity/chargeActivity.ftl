    ...
    layui.use(['layer', 'form', 'table', 'util', 'admin', 'formSelects', "xmSelect", 'laydate'], function () {
        ...
        var insTb = table.render({
            ...
            cols: [[
                ...
                {field: 'activityType', align: 'center', title: '活动类型',templet:function (d) {if (d.activityType==0){return '送金额';}else {return '送礼品'}}},
                {field: 'chargeMomey', align: 'center', title: '充值金额',templet:function (d) {return d.chargeMomey+'元'}},
                {field: 'discountsMomey', align: 'center', title: '实际到账金额',templet:function (d) {return d.discountsMomey+'元'}},
                {field: 'note', align: 'center', title: '活动礼品'},
                {field: 'multi', align: 'center', title: '是否能多次参加',templet: function (d) {if (d.multi==0){return '可以'} else{return '不可以'}}},
                {field: 'startDate', align: 'center',width:200, title: '活动开始日期'},
                {field: 'endDate', align: 'center',width:200, title: '活动截止日期'},
                {field: 'createDate', align: 'center',width:200,title: '活动创建日期'},
